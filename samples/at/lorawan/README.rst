.. zephyr:code-sample:: rzi_at_lorawan
   :name: RZI AT LoRaWAN
   :relevant-api: rzi_at rzi_lorawan
...
The UART adapter feeds the I/O-independent AT framework. The optional
...
.. code-block:: console
   ...
   west build -b rzi_rak4631/nrf52840 --sysbuild samples/at/lorawan
